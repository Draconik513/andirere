    ...
    const updateAudio = () => {
      if (iframeRef.current) {
        ...
        try {
          ...
          iframe.src = `https://www.youtube.com/embed/QqJ-Vp8mvbk?autoplay=1&loop=1&playlist=QqJ-Vp8mvbk&enablejsapi=1&${isMusicPlaying ? 'mute=0' : 'mute=1'}`;
        } catch (error) {
    ...
    <>
      ...
      <div style={{ 
        ...
        <iframe
          ...
          width="1"
          height="1"
          src={`https://www.youtube.com/embed/QqJ-Vp8mvbk?autoplay=1&loop=1&playlist=QqJ-Vp8mvbk&enablejsapi=1&mute=0`}
